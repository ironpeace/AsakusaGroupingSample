...
import ironpeace.modelgen.dmdl.io.Term2012Input;
import ironpeace.modelgen.dmdl.io.Term2012Output;
...
/**
 * term2012を表すデータモデルクラス。
 */
@DataModelKind("DMDL")@ModelInputLocation(Term2012Input.class)@ModelOutputLocation(Term2012Output.class)@PropertyOrder({
            "keycode", "userid", "term", "data"}) public class Term2012 implements DataModel<Term2012>, Writable {
    ...
    @Override@SuppressWarnings("deprecation") public void copyFrom(Term2012 other) {
