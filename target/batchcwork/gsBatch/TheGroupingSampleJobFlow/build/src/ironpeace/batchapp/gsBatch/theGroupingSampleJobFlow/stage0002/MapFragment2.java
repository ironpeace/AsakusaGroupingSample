...
/**
 * {@code [mid1->GroupingSampleOperator.convertToMid2FromMid1(operator#757856402)]}の処理を担当するマッププログラムの断片。
 */
@SuppressWarnings("deprecation") public final class MapFragment2 implements Result<Middata1> {
     ...
     */
    public MapFragment2(Result<Middata1> original, Result<Middata2> out) {
